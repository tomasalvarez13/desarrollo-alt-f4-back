...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'sing in' do
    post '/register',
         params: { name: 'Fernando', lastname: 'Olivos', username: 'fernando@user.cl', role: 1, password: 'santiago' }, as: :json
    assert_response :success
  end
  ...
  test 'edit user' do
    patch "/users/#{@user.id}", params: { name: 'Fernando', lastname: 'Olivos', role: 1, password: 'santiago' },
                                as: :json, headers: { 'HTTP_AUTHORIZATION' => @authorization }
    assert_response :success
  end
