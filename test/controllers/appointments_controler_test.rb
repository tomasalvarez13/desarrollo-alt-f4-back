...
class AppointmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'crear appointment sin token' do
    post '/appointments',
         params: { descrption: 'long description 2', start_time: '2022-02-03T12:00:00+00:00', end_time: '2022-02-03T12:01:00+00:00' }, as: :json
    assert_response 401
  end

  test 'crear appointment con token' do
    post '/appointments',
         params: { descrption: 'long description 2', start_time: '2022-02-03T12:00:00+00:00', end_time: '2022-02-03T12:01:00+00:00' }, as: :json, headers: { 'HTTP_AUTHORIZATION' => @authorization }
    assert_response :success
  end

  test 'edit appointment' do
    patch "/appointments/#{@appointment.id}",
          params: { descrption: 'long description', start_time: '2022-02-03T12:00:00+00:00', end_time: '2022-02-03T12:02:00+00:00' }, as: :json, headers: { 'HTTP_AUTHORIZATION' => @authorization }
    assert_response :success
  end

  test 'edit appointment sin token' do
    patch "/appointments/#{@appointment.id}",
          params: { descrption: 'long description', start_time: '2022-02-03T12:00:00+00:00', end_time: '2022-02-03T12:02:00+00:00' }, as: :json
    assert_response 401
  end
